        ...
        <div class="menu">
            <form action="index.php">
                <div class="search-sidebar">
                    ...
                    <input type="text" id="searchInput" class="input-search" name="search_query" placeholder="CARI DISINI ..." onkeyup="searchSidebar()">
                </div>
            </form>
            <ul class="list" id="listQuery">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="?p=<?php echo crypt('aspek', 'DitoCahyaPratama') ?>">Data Inti Aspek</a>
                        </li>
                        <li>
                            <a href="?p=<?php echo crypt('kompetensi', 'DitoCahyaPratama') ?>">Data Inti Kompetensi</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="?p=<?php echo crypt('prota', 'DitoCahyaPratama') ?>">Data Program Tahunan</a>
                        </li>
                        <li>
                            <a href="?p=<?php echo crypt('promes', 'DitoCahyaPratama') ?>">Data Program Semester</a>
                        </li>
                        <li>
                            <a href="?p=<?php echo crypt('propeng', 'DitoCahyaPratama') ?>">Data Program Pengembangan</a>
                        </li>
                        <li>
                            <a href="?p=<?php echo crypt('rppm', 'DitoCahyaPratama') ?>">Data Program RPPM</a>
                        </li>
                        <li>
                            <a href="?p=<?php echo crypt('rpph', 'DitoCahyaPratama') ?>">Data Program RPPH</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<script>
    function searchSidebar() {
        var input, filter, ul, li, ul2, li2, a, i, j, k, txtValue;
        input = document.getElementById("searchInput");
        filter = input.value.toUpperCase();
        ul = document.getElementById("listQuery");
